...
Flags32		g_uCommonFlags		= {flAiUseTorchDynamicLights|uiShowConditions|uiShowExtDesc|uiShowFocused|gpDeferredReload|gpFixedReload|uiShowTradeSB|gpPauseOnGameStart};
// textures 
int			psTextureLOD		= 0;
