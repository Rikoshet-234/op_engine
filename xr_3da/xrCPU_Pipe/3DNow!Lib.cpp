...
static const __m64i smh_masks   =   { static_cast<int>(0x807fffff),   static_cast<int>(0x807fffff)}; // dword MASKSMH, MASKSMH
static const __m64i sign_mask   =   { 0x7fffffff,   0x7fffffff      };
static const __m64i sh_masks    =   { static_cast<int>(0x80000000),   static_cast<int>(0x80000000)}; // dword MASKSH, MASKSH
...
static const __m64i pio4ht      =   { static_cast<int>(0xbf490000),   static_cast<int>(0xb97daa22)};  // approximately -0.000241913 | -0.785156
