...
void CAI_Stalker::can_kill_entity		(const Fvector &position, const Fvector &direction, float distance, collide::rq_results& r_rq_storage)
{
	...
	Level().ObjectSpace.RayQuery	(r_rq_storage,ray_defs,ray_query_callback,&params,NULL,this);
