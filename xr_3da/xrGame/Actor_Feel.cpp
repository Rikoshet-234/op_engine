...
void	CActor::PickupModeUpdate_COD	()
{
	...
	{
		ISpatial*		spatial2	= ISpatialResult[o_it];
		CInventoryItem*	pIItem	= smart_cast<CInventoryItem*> (spatial2->dcast_CObject        ());
		...
		CGrenade*	pGrenade	= smart_cast<CGrenade*> (spatial2->dcast_CObject        ());
		if (pGrenade && !pGrenade->Useful()) continue;

		CMissile*	pMissile	= smart_cast<CMissile*> (spatial2->dcast_CObject        ());
