...
enum {
	...
	GE_REINIT_ADDONS,
	GE_REINIT_MAIN_INGAME_HUD,
	GE_UPDATE_SERVER_ENTRY_IAI_COST,
	GE_UPDATE_SERVER_ENTRY_IAI_WEIGHT,
	GE_UPDATE_SERVER_ENTRY_IAI_RADIATION,
	GEG_PLAYER_ITEM_USE,
	GE_UPDATE_SERVER_ENTRY_IAI_CONDITION,
	GE_FORCEDWORD				= u32(-1)
};
