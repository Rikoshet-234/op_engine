...
CScriptGameObject *get_object_by_id_pointer(u32 *id)
{
	if (id==nullptr)
	{
		return nullptr;
...
CEnvDescriptor *current_environment(CEnvironment *pself)
{
	return		(&pself->CurrentEnv);
}
...
void CLevel::script_register(lua_State *L)
{
	...
	[
		// obsolete\deprecated
		def("object_by_id",						get_object_by_id_pointer),
		def("object_by_id",						get_object_by_id),
		//def("object_by_id",						reinterpret_cast<CScriptGameObject& (*)(u32)>(&get_object_by_id)),
