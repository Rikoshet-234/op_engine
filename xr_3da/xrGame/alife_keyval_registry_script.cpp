...
void CALifeKeyvalContainer::script_register(lua_State *L)
{
	...
	[
		class_<CALifeKeyvalContainer>("CALifeKeyvalContainer")
			//.def("get", static_cast<luabind::object (CALifeKeyvalContainer*) (LPCSTR)>(&CALifeKeyvalContainer::get))
			.def("get", static_cast<luabind::object (CALifeKeyvalContainer::*)(LPCSTR)>(&CALifeKeyvalContainer::get))
			.def("get", static_cast<luabind::object (CALifeKeyvalContainer::*)(LPCSTR,luabind::object const&)>(&CALifeKeyvalContainer::get))
