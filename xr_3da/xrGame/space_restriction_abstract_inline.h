...
#ifdef CHECK_RESTRICTORS_BEMPTY
	R_ASSERT3(!m_accessible_neighbour_border.empty(),"CSpaceRestrictionAbstract::accessible_neighbour_border Space restrictor has no accessible neighbours",*name());
#endif
