...
public:
	...
	PIItem					Get(shared_str name, bool bSearchRuck) const;
	...
	void				AddAvailableItems			(TIItemContainer& items_container, bool for_trade,bool useBelt=true,bool useSlots=true) const;
