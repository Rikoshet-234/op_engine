...
public:
	...
	void 		SetWndPos_script(float x, float y) {CUISimpleWindow::SetWndPos(x,y);}
	...
	void		SetHeight_script(float height)	{CUISimpleWindow::SetHeight(height);}
	void		SetWidth_script(float width)	{CUISimpleWindow::SetWidth(width);}
