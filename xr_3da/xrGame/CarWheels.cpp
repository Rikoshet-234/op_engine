...
void CCar::SWheelSteer::Init()
{
	...
	float lsteering_torque=pKinematics->LL_UserData()->r_float("car_definition","steering_torque");
	pwheel->ApplySteerAxisTorque(lsteering_torque);
	dJointSetHinge2Param(pwheel->joint->GetDJoint(), dParamFudgeFactor, 0.005f/ lsteering_torque);
