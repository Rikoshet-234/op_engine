...
CALifeMonsterDetailPathManager *get_detail(const CALifeMonsterMovementManager *pself)
{
	return	(&pself->detail());
}

CALifeMonsterPatrolPathManager *get_patrol(const CALifeMonsterMovementManager *pself)
{
	return	(&pself->patrol());
}
