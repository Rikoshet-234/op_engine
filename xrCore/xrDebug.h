...
public:
	...
	void __cdecl	fatal				(const char *file, int line, const char *function, const char* description,const char* arguments);
	void __cdecl	fatal				(const char *file, int line, const char *function, const char* F,...);
