...
//#define HAVE_SSE//NickGalko:because needed __control87_2
...
//NickGalko:MSDN:
//__control87_2 не поддерживается в архитектурах ARM или x64. При использовании __control87_2 и компилировать программу для архитектур ARM или x64, компилятор выдает ошибку.
