...
#define __ICEPLANE_H__
	...
	class ICEMATHS_API Plane
	{
		...
		inline_	Plane&	Set(float nx, float ny, float nz, float ld)						{ n.Set(nx, ny, nz); d = ld;	    return *this;	}
		inline_	Plane&	Set(const Point& p, const Point& ln)							{ n = ln; d = - p | ln;			    return *this;	}
